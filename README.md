...
- Create and checkout your own git branch `Participant-ID-fix` to get started. Remove code smells from the code. Your goal is to find out what code smells are, where it occured, and how you can fix it?
